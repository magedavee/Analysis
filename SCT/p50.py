...
for i,ny in enumerate(nyList):
    if ny==1 :
        dt[1].append(dtList[i])
    else :
        dt[0].append(dtList[i])
plt.hist(dt[0],bins=100,alpha=.5)
plt.hist(dt[1],bins=100,alpha=.5)
plt.title("Delta T(ns)")
plt.show()
print " mean top : "+str(np.array(dt[1]).mean())
print " std top : "+str(np.array(dt[1]).std())
print " mean bot : "+str(np.array(dt[0]).mean())
print " std bot : "+str(np.array(dt[0]).std())
#######ypos################ 
y=[[],[]]
print "Pos"
for i,ny in enumerate(nyList):
    if ny==1 :
        ...
        y[0].append(yList[i])
plt.hist(y[1],bins=100,alpha=.5)
plt.hist(y[0],bins=100,alpha=.5)
plt.title("Postion Along Cell (cm)")
plt.show()
print " mean top : "+str(np.array(y[1]).mean())
print " std top :  "+str(np.array(y[1]).std())
print " mean bot : "+str(np.array(y[0]).mean())
print " std bot :  "+str(np.array(y[0]).std())
###############dt var left vs len ########
